...
from gen_model.vaeac.nn_utils import MemoryLayer, SkipConnection
from gen_model.vaeac.prob_utils import CategoricalToOneHotLayer, GaussianCategoricalLoss, GaussianCategoricalSampler, SetGaussianSigmasToOne
